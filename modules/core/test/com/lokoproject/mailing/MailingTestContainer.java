...
public class MailingTestContainer extends TestContainer {

    public MailingTestContainer() {
        super();
    ...
    public static class Common extends MailingTestContainer {

        public static final MailingTestContainer.Common INSTANCE = new MailingTestContainer.Common();
