...
alter table MAILING_MAILING add constraint FK_MAILING_MAILING_ON_ADAPTER_FOR_MAILING_TARGET_SCREEN foreign key (ADAPTER_FOR_MAILING_TARGET_SCREEN_ID) references MAILING_GROOVY_SCRIPT(ID)^
...
create index IDX_MAILING_MAILING_ON_ADAPTER_FOR_MAILING_TARGET_SCREEN on MAILING_MAILING (ADAPTER_FOR_MAILING_TARGET_SCREEN_ID)^
-- end MAILING_MAILING
...
alter table MAILING_MAILING_GROOVY_SCRIPT_LINK add constraint FK_MAIGROSCR_ON_MAILING foreign key (MAILING_ID) references MAILING_MAILING(ID)^
alter table MAILING_MAILING_GROOVY_SCRIPT_LINK add constraint FK_MAIGROSCR_ON_GROOVY_SCRIPT foreign key (GROOVY_SCRIPT_ID) references MAILING_GROOVY_SCRIPT(ID)^
